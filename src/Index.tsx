...
const copy = {
  ...
  zh: {
    nav: { home: "首页", work: "游记", contact: "来信", sayHi: "寄一封信" },
    hero: {
      eyebrow: "深圳 / 少年气 / 智能体",
      name: "黄俊铭",
      prefix: "一个",
      suffix: "电子科技大学毕业生。",
      roles: ["写 Agent 的少年", "造大模型应用的人", "SRE 路上的解题人", "嘻嘻哈哈向前走"],
      body:
        "长风破浪会有时，直挂云帆济沧海。住在深圳的日子里，我把 Agent 和大模型应用做成可靠的工具，也把生活过得轻快一点。",
      primary: "翻开小记",
      secondary: "来信给我",
      scroll: "下行",
    },
    archive: {
      ...
      titleAccent: "有风",
      titleB: "也有光",
      intro: "海上生明月，好友在身旁；练过一身汗，也捧回几页奖状。",
      button: "且看风来",
      travelKicker: "北海 / 乘风",
      travelTitle: "海阔，\n风轻。",
      travelBody: "潮平两岸阔，风正一帆悬。把蓝色留给眼睛，把自由留给明天。",
      friendsKicker: "同游",
      friendsTitle: "相逢意气",
      friendsBody: "相逢意气为君饮，普通日子也有了清亮回声。",
      fitnessKicker: "健身",
      fitnessLabels: ["少年负壮气", "汗落成光", "轻装再走"],
      specialKicker: "心上章",
      specialTitle: "春水微澜",
    ...
    footer: {
      kicker: "来信",
      title: "有事共赴青山，无事各自生风。欢迎聊项目，也聊一点轻快的玩笑。",
    },
  },
} as const;
